...
wordid =20; %397; %37;% set a random value and we intead to find 20 patches from both training and test
...
idright = right_v(24);% set number you are about to visualize
idwrong = wrong_v(2);% set number you are about to visualize, be sure it is nor larger than length of wrong_v 
